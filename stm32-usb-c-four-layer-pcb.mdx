...
```text
  ...
  Core               ~1.0 mm
  ───────────────────────────────────────
  Layer 3 (Inner 2): Power Plane (3.3V)
  ═══════════════════════════════════════
  Prepreg            ~0.2 mm
  ───────────────────────────────────────
  ...
  GND plane directly below signal traces
  provides low-impedance return path and
  reduces EMI. Via stitching connects
  top and bottom ground areas.
```
...
```text
  ...
  ──────────────────────────────────────────
  USB-C connector         STM32 USB pins
       │                       │
       │  D+  ════════════  PA12 (D+)
       │  D-  ════════════  PA11 (D-)
       │
  ...
  - No vias in the pair
  - Keep 3x trace width clearance
    from other signals
  - Ground plane unbroken beneath pair
```
...
<LinkButton href="https://github.com/SiliconWit/pcb-design-kicad/blob/main/schematics/stm32-usb-c-four-layer-pcb.pdf" target="_blank" variant="secondary" icon="document">Download Schematic PDF</LinkButton>
