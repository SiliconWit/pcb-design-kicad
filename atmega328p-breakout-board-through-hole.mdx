...
| Power | 7-12V input via barrel jack, 5V regulator (LM7805 in TO-220) |
...
2. **Place the voltage regulator.** Add `LM7805_TO220` (search for `7805` in the symbol library). Place it to the right of the barrel jack.
